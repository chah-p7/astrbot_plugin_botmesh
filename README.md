...
0.13.7 起，主动消息不必提问或以问句结尾，可以自然表达感受、观察、见闻、小事、感叹与联想。
发送审核会把未包 JSON 但内容安全的自然纯文本保留为全群消息；已知名字只有以 `@名字`、
“名字，”或“名字：”等明确收件人形式开头时才会触发点名保护，“莉芙的长头发……”等叙事
不再误杀。未知目标、错误称呼、身份签名、平台路由和防回流检查仍保持严格。
